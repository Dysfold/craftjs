...
buffer: JArray<number>;
column: number;
index: number;
line: number;
name: string;
pointer: number;
getBuffer(): JArray<number>;
getColumn(): number;
getIndex(): number;
getLine(): number;
getName(): string;
...
toString(): string;
constructor(arg0: string, arg1: number, arg2: number, arg3: number, arg4: JArray<number>, arg5: number);
constructor(arg0: string, arg1: number, arg2: number, arg3: number, arg4: JArray<string>, arg5: number);
...
static values(): JArray<org_yaml_snakeyaml_nodes_NodeId>;
wait(): void;
...
static values(): JArray<org_yaml_snakeyaml_events_Event_ID>;
wait(): void;
wait(arg0: number): void;
wait(arg0: number, arg1: number): void;
...
actualTypeArguments: JArray<java_lang_Class<java_lang_Object>>;
annotation: A;
...
getActualTypeArguments(): JArray<java_lang_Class<java_lang_Object>>;
...
static values(): JArray<org_yaml_snakeyaml_introspector_BeanAccess>;
wait(): void;
wait(arg0: number): void;
wait(arg0: number, arg1: number): void;
...
tag: org_yaml_snakeyaml_nodes_Tag;
type: java_lang_Class<java_lang_Object>;
addPropertyParameters(arg0: string, ...arg1: JArray<java_lang_Class<java_lang_Object>>): void;
...
setExcludes(...arg0: JArray<string>): void;
setIncludes(...arg0: JArray<string>): void;
...
substituteProperty(arg0: string, arg1: java_lang_Class<java_lang_Object>, arg2: string, arg3: string, ...arg4: JArray<java_lang_Class<java_lang_Object>>): void;
toString(): string;
constructor(arg0: java_lang_Class<java_lang_Object>);
...
notifyAll(): void;
set(arg0: java_lang_Object, arg1: java_lang_Object): void;
setActualTypeArguments(...arg0: JArray<java_lang_Class<java_lang_Object>>): void;
setDelegate(arg0: org_yaml_snakeyaml_introspector_Property): void;
setTargetType(arg0: java_lang_Class<java_lang_Object>): void;
wait(): void;
wait(arg0: number): void;
wait(arg0: number, arg1: number): void;
constructor(arg0: string, arg1: java_lang_Class<java_lang_Object>, ...arg2: JArray<java_lang_Class<java_lang_Object>>);
constructor(arg0: string, arg1: java_lang_Class<java_lang_Object>, arg2: string, arg3: string, ...arg4: JArray<java_lang_Class<java_lang_Object>>);
  }
}
//@ts-nocheck
...
static values(): JArray<org_yaml_snakeyaml_DumperOptions_FlowStyle>;
toString(): string;
wait(): void;
wait(arg0: number): void;
wait(arg0: number, arg1: number): void;
...
static values(): JArray<org_yaml_snakeyaml_DumperOptions_ScalarStyle>;
toString(): string;
wait(): void;
wait(arg0: number): void;
wait(arg0: number, arg1: number): void;
...
static values(): JArray<org_yaml_snakeyaml_DumperOptions_Version>;
toString(): string;
wait(): void;
wait(arg0: number): void;
wait(arg0: number, arg1: number): void;
...
static values(): JArray<org_yaml_snakeyaml_DumperOptions_NonPrintableStyle>;
wait(): void;
wait(arg0: number): void;
wait(arg0: number, arg1: number): void;
...
static values(): JArray<org_yaml_snakeyaml_DumperOptions_LineBreak>;
toString(): string;
wait(): void;
wait(arg0: number): void;
wait(arg0: number, arg1: number): void;
